...
#     "acmg_classification_base",  # Added field
#     "DP", "FS", "FractionInformativeReads", "MQ", "MQRankSum", "QD", "R2_5P_bias", 
#     "ReadPosRankSum", "SOR", "VQSLOD", "acmg_criteria_base", "acmg_score_base", 
#     "allele_count_reference_population_base", "computational_prediction_selected_base", 
#     "computational_score_selected_base", "computational_source_selected_base", 
#     "culprit", "effect_base", "gene_symbol_base", "hom_count_reference_population_base", 
#     "splice_prediction_selected_base", "splice_score_selected_base", 
#     "splice_source_selected_base", "transcript_base", "zygosity"
# ]


info_columns = [
    "#CHROM", "POS", "ID", "REF", "ALT", 
    "acmg_classification_base", "acmg_criteria_base", "acmg_score_base"
]
